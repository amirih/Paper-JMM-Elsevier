...
int main()
{
	...
	int i, j,k=0,temp;
	//That means Conc=volution code which is modified for a 9x9 and the code is written in C and IPM is not used Number 1 means the basic implementation
	programName="CONMOD91";
